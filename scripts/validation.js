...
function validateName(value) {
  ...
  if (value.length > nameMaxLength) return `The name may be at most ${nameMaxLength} characters long.`;
  if (!namePattern.test(value)) return "The name may only contain letters.";
  return "";
}
...
function validatePassword(value) {
  ...
  if (!isPasswordLongEnough(value)) return "Your password must be at least " + passwordMinLength + " characters long.";
  return "";
}
